...
function PostCard({ post }) {
  ...
  const liked = post.Likers.find((i) => i.id === id);
  ...
  return (
    <div style={{ marginBottom: 20 }}>
      <Card
        cover={post.Images[0] && <PostImages images={post.Images} style={{ maring: '0px' }} />}
        actions={[
      ...
      >
        {post.RetweetId && post.Retweet ? (
          <Card cover={post.Retweet.Images && <PostImages images={post.Retweet.Images} />}>
            <div style={{ float: 'right', color: 'rgba(0, 0, 0, 0.45)' }}>{moment(post.createdAt).format('YYYY.MM.DD')}</div>
            <Card.Meta
              avatar={
          ...
          <>
            <div style={{ float: 'right', color: 'rgba(0, 0, 0, 0.45)' }}>{moment(post.createdAt).fromNow()}</div>
            <Card.Meta
              avatar={
